#ifndef HASH_BLAZER_SHA256_HASHER_HXX
#define HASH_BLAZER_SHA256_HASHER_HXX
...
class SHA256_Hasher {
 public:
  constexpr static size_t HASH_SIZE_BYTES = 32;
...
static_assert(isHasher<SHA256_Hasher>,
              "SHA256_Hasher doesn't satisfy isHasher<> concept.");
